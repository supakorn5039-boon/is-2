...
plt.annotate(f"Input Occupancy Level: {input_occupancy:.2f}", xy=(0.85, 0.95), xycoords='axes fraction', ha='right')
plt.annotate(f"Input Time of Day: {input_time_of_day:.2f}", xy=(0.85, 0.9), xycoords='axes fraction', ha='right')
plt.annotate(f"Parking Availability: {percentage_result:.2%}", xy=(0.85, 0.85), xycoords='axes fraction', ha='right')
