...
plt.annotate(f"Input Occupancy Level: {input_occupancy:.2f}", xy=(0.5, 0.95), xycoords='axes fraction', ha='top-right')
plt.annotate(f"Input Time of Day: {input_time_of_day:.2f}", xy=(0.5, 0.9), xycoords='axes fraction', ha='top-right')
