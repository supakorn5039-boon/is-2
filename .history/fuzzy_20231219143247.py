...
# Generate random values for input_occupancy and input_time_of_day
input_occupancy = np.random.uniform(0, 100)  # Generates a random float between 0 and 100
input_time_of_day = np.random.uniform(0, 24)  # Generates a random float between 0 and 24

print("Random input_occupancy:", input_occupancy)
print("Random input_time_of_day:", input_time_of_day)
