...
input_occupancy = np.random.uniform(0, 100)  # Random value between 0 and 100
input_time_of_day = np.random.uniform(0, 24)  # Random value between 0 and 24
...
# Print the result and input values
print("Input Occupancy Level:", input_occupancy)
print("Input Time of Day:", input_time_of_day)
